                            ...
                            <ul>
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="/imgs/nav-img/nav-2-1.png" alt="">
                                        </div>
                                        <div class="pro-name">Redmi 9</div>
                                        <div class="pro-price">799元起</div>
                                    </a>
                                </li>
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="/imgs/nav-img/nav-2-2.png" alt="">
                                        </div>
                                        <div class="pro-name">Redmi 10X 4G</div>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="/imgs/nav-img/nav-2-3.png" alt="">
                                        </div>
                                        <div class="pro-name">Redmi 10X 5G系列</div>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="/imgs/nav-img/nav-2-4.jpg" alt="">
                                        </div>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="/imgs/nav-img/nav-2-5.jpg" alt="">
                                        </div>
                                        <div class="pro-name">Redmi K30 Pro变焦版</div>
                                ...
                                <li class="product">
                                    <a href="" target="_blank">
                                        <div class="pro-img">
                                            <img src="/imgs/nav-img/nav-2-6.jpg" alt="">
                                        </div>
                                        <div class="pro-name">Redmi K30</div>
                                        <div class="pro-price">1499元起</div>
                                    </a>
                                </li>
                            </ul>
                        </div>
